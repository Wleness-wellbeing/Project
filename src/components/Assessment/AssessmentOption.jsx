...
export default function AssessmentOption(props) {
  return (
    <div className="group box-border flex items-stretch">
      <label
        title={props.name}
        className={`flex w-full cursor-pointer items-center justify-center rounded-md border-2 border-primary-300 bg-white px-2 py-1.5 text-xs font-semibold transition-all hover:border-transparent md:text-sm lg:px-3 lg:py-3 lg:text-base ${
          props.checked
