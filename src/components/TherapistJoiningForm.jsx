...
import { therapistJoiningPersonalInputs } from "../data/joiningForm";
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      if (
        ...
        const response = await axios.post("http://localhost:3000/therapist", {
          personalDetails,
          professionalDetails,
        });
          ...
          <>
            <div className="mx-auto  w-3/4  rounded-2xl p-8 shadow-lg shadow-slate-300">
              ...
              <div className="my-10 grid grid-cols-2 gap-4">
                {therapistJoiningPersonalInputs.map((value, i) => {
                  return <Input data={value} key={i} />;
                })}
              </div>
