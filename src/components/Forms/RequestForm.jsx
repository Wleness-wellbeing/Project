...
function RequestForm() {
  ...
  return (
    <section className="p-4 lg:p-0">
      <div className="container mx-auto mb-6 grid rounded-3xl bg-yellow-primary px-6 py-8 xs:px-8 xs:py-14 md:grid-cols-2 lg:px-8 lg:py-16 2xl:py-20">
        ...
        >
          <label className="mb-3">
            <input
              ...
              name="name"
              className="block w-full rounded-md px-6 py-4 shadow-md outline-none focus:ring focus:ring-violet-400 focus:ring-opacity-75 dark:bg-white"
            />
          </label>
          <label className="mb-3">
            <input
