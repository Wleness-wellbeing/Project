  ...
  return (
    <div class="shadow-2xl border-2 w-[245px] h-auto rounded-lg m-1 bg-white border-gray-200 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="flex flex-col justify-center items-center">
        <button
          type="button"
          class="text-white bg-[#008080] py-2.5 px-8 mr-2 mb-3 text-sm font-medium focus:outline-none rounded-full"
        >
          Default
        </button>
        <button
          type="button"
          class="py-2.5 px-8 mr-2 mb-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-[#008080] hover:bg-gray-100 "
        >
          Update
        </button>
