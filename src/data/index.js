    ...
    types: [
      {
        ...
        desc: "Hatha yoga is a traditional form of physical and mental exercise originating from ancient Indian practices. It combines asanas (physical postures) and pranayama (breath control) to enhance overall well-being. Focusing on balance and alignment, Hatha yoga aims to harmonise the body and mind through mindful movement and breath awareness.",
        slug: "/activities/yoga/hatha-yoga",
      },
      {
        title: "Ashtanga Yoga",
        thumbnail: yoga__AshtangaYoga,
        desc: "Ashtanga yoga is a dynamic and physically demanding style rooted in ancient Indian traditions. Consisting of a set series of poses linked by breath and movement, it emphasises strength, flexibility, and stamina. Guided by the principles of Tristhana (posture, breath, and focal point), Ashtanga aims to purify the body and cultivate inner stillness.",
      ...
      },
      {
        ...
        desc: "Mindful breathing involves consciously observing and controlling the breath to stabilise oneself in the present moment. This practice, integral to mindfulness, fosters a calm awareness of thoughts and sensations. By focusing on the breath, individuals can enhance mental clarity, reduce stress, and cultivate a more grounded and mindful state of being.",
        slug: "/activities/yoga/breathe-and-mindfullness",
      },
      {
        title: "Therapautic yoga",
        thumbnail: yoga__TherapauticYoga,
        desc: "Therapeutic yoga is a holistic approach that integrates yoga principles with medical science to address physical, mental, and emotional health issues. Tailored to individual needs, it employs asanas, breathwork, and meditation to ease symptoms, promote healing, and enhance overall well-being, fostering a harmonious connection between body and mind.",
        slug: "/activities/yoga/therapautic-yoga",
      },
      {
        title: "Yoga for women",
        thumbnail: yoga__WomenYoga,
        desc: "Yoga for women is a transformative practice addressing the unique physical and emotional needs throughout various life stages. Tailored sequences and poses promote strength, flexibility, and balance. Emphasis on mindfulness and relaxation aids in managing stress and hormonal changes, enhancing overall women's health, and fostering empowerment and well-being.",
