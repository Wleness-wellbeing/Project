    ...
    <>
      ...
      <section className="container mx-auto space-y-5 py-8 text-justify font-medium">
        <p>
          ...
          <strong> GREEN CLOVER IT SYSTEMS PRIVATE LIMITED</strong> uses and
          protects any information that you give GREEN CLOVER IT SYSTEMS PRIVATE
          LIMITED when you use this website.
        </p>
        <p>
          <strong> GREEN CLOVER IT SYSTEMS PRIVATE LIMITED </strong>
        ...
        <p>
          <strong>GREEN CLOVER IT SYSTEMS PRIVATE LIMITED </strong> may change
